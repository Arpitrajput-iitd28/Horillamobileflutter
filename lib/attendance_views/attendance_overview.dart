...
//                   indicatorColor: const Color.fromARGB(255,100,7,0),
//                   labelColor: const Color.fromARGB(255,100,7,0),
...
//                 decoration: BoxDecoration(
//                   color: const Color.fromARGB(255,100,7,0).withOpacity(0.07),
//                   borderRadius: BorderRadius.circular(10.0),
//                 ),
//                 child: Center(
//                   child: Text(
...
//                 child: const Text(
//                   'Send',
//                   style: TextStyle(color: const Color.fromARGB(255,100,7,0)),
//                 ),
//                 onPressed: () async {
//                   await sendEmail(
...
class _AttendanceOverviewState extends State<AttendanceOverview>
  ...
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  late TabController _tabController;
  late String todayAttendance = '80';
  late String offlineEmpCount = '5';
  TextEditingController bodyController = TextEditingController();
  List<Map<String, dynamic>> requestsOfflineEmployees = [];
  List<Map<String, dynamic>> requestsOvertimeValidate = [];
  List<Map<String, dynamic>> requestsNonValidAttendance = [];
  ...
  bool _isShimmerVisible = true;
  bool permissionOverview = true;
  bool permissionAttendance = true;
  bool permissionAttendanceRequest = true;
  bool permissionHourAccount = true;

  // Mock data
  final List<Map<String, dynamic>> mockOfflineEmployees = [
    {
  ...
  final List<Map<String, dynamic>> mockOvertimeValidate = [
    {
  ...
  void initState() {
    ...
    requestsOfflineEmployees = List.from(mockOfflineEmployees);
    requestsOvertimeValidate = List.from(mockOvertimeValidate);
    requestsNonValidAttendance = List.from(mockNonValidAttendance);
    
    // Set counts based on mock data
    offlineEmpCount = requestsOfflineEmployees.length.toString();
    overtimeValidate = requestsOvertimeValidate.length;
    nonValidated = requestsNonValidAttendance.length;
    
    _simulateLoading();
  }

  Future _simulateLoading() async {
  ...
  void _scrollListener() {
    // Pagination logic without API calls
  }
            ...
            child: Column(
              children: [
                TabBar(
                  ...
                  isScrollable: true,
                  labelStyle:
                      TextStyle(fontWeight: FontWeight.bold, fontSize: fontSize * 1.2),
                  tabs: [
                    Tab(text: 'Overtime Validate ($overtimeValidate)'),
                    Tab(text: 'Non Validated ($nonValidated)'),
                  ],
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      overtimeValidate == 0
                          ...
                          : buildOvertimeValidate(
                              requestsOvertimeValidate, _scrollController),
                      nonValidated == 0
                          ? const Center(
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                          ...
                          : buildNonValidatedAttendance(
                              requestsNonValidAttendance, _scrollController)
                    ],
                  ),
                ),
              ],
  ...
  Widget buildOfflineEmployeesTile(
      Map<String, dynamic> record, String leaveStatus, BuildContext context) {
    return Column(
      children: [
        ListTile(
          leading: CircleAvatar(
  ...
  Widget buildOvertimeValidate(
    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemCount: requestsOvertimeValidate.length,
        itemBuilder: (context, index) {
          Map record = requestsOvertimeValidate[index];
          return Column(
            children: [
              GestureDetector(
                onTap: () {
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildDetailRow(
                                      'Check In', record['attendance_clock_in']),
                                  _buildDetailRow('Check In Date',
                                      record['attendance_clock_in_date']),
                                  _buildDetailRow(
                                      'Check Out', record['attendance_clock_out']),
                                  _buildDetailRow('Check Out Date',
                                      record['attendance_clock_out_date']),
                                  _buildDetailRow('Shift', record['shift_name']),
                                  _buildDetailRow(
                                      'Work Type', record['work_type']),
                                  _buildDetailRow(
                                      'At Work', record['attendance_worked_hour']),
                                  _buildDetailRow(
                                      'Min Hour', record['minimum_hour']),
                                ],
                              ),
                            ),
                          ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfoRow('Date', record['attendance_date']),
  ...
  Widget buildNonValidatedAttendance(
    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemCount: requestsNonValidAttendance.length,
        itemBuilder: (context, index) {
          Map record = requestsNonValidAttendance[index];
          return Column(
            children: [
              GestureDetector(
                onTap: () {
