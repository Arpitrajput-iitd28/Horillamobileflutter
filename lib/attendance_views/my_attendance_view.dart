...
class _MyAttendanceViews extends State<MyAttendanceViews>
  ...
  // MOCK DATA for employee and attendance
  String employeeName = 'Alice Smith';
  String employeeProfile = ''; // Leave empty for default icon
  String badgeId = 'EMP001';
  String shiftName = 'Morning';
  String attendanceDate = '2025-06-24';
  String attendanceClockInDate = '2025-06-24';
  String attendanceClockIn = '09:00';
  String attendanceClockOutDate = '2025-06-24';
  String attendanceClockOut = '17:00';
  String attendanceWorkedHour = '08:00';
  String minimumHour = '08:00';
  bool permissionCheck = true;

  @override
  void initState() {
    super.initState();
    // No API or SharedPreferences, all mock data above
  }
  ...
  @override
  Widget build(BuildContext context) {
    // No ModalRoute args, use mock data
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        backgroundColor: Colors.white,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _attendanceRow('Date', attendanceDate),
            _attendanceRow('Check-In', attendanceClockIn),
            _attendanceRow('Check-Out', attendanceClockOut),
            _attendanceRow('Shift', shiftName),
            _attendanceRow('Minimum Hour', minimumHour),
            _attendanceRow('Check-In Date', attendanceClockInDate),
            _attendanceRow('Check-Out Date', attendanceClockOutDate),
            _attendanceRow('At Work', attendanceWorkedHour),
            SizedBox(height: MediaQuery.of(context).size.height * 0.01),
          ],
        ),
      ),
