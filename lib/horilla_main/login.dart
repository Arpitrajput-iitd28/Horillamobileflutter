...
Future _login() async {
  // For development: bypass authentication and go directly to home
  Navigator.pushReplacementNamed(context, '/home');
}


  /// Logs in the user by sending a POST request to the server. This is the actual authentification Logic . the above three lines are for developers .
            ...
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  color: const Color.fromARGB(255, 106, 7, 0),
                ),
