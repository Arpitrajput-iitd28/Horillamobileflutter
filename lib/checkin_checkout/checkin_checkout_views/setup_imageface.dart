                  ...
                  child: SizedBox(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border.all(color: const Color.fromARGB(255,100,7,0)!, width: 3),
                  ...
                  children: [
                    ...
                    if (_capturedImage != null) ...[
                      OutlinedButton.icon(
                        ...
                        icon: const Icon(Icons.refresh, color: const Color.fromARGB(255,100,7,0)),
                        label: const Text('Retake'),
                        style: OutlinedButton.styleFrom(
                          foregroundColor: const Color.fromARGB(255,100,7,0),
                          side: BorderSide(color: const Color.fromARGB(255,100,7,0)!),
                          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                        ),
                      ),
