                  ...
                  actions: [
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ButtonStyle(
                          backgroundColor:
                          MaterialStateProperty.all<Color>(const Color.fromARGB(255,100,7,0)),
                          shape:
                  ...
                  if (_errorMessage != null)
                    Padding(
                      ...
                      child: Text(
                        _errorMessage ?? '',
                        style: const TextStyle(
                            color: const Color.fromARGB(255,100,7,0), fontWeight: FontWeight.bold),
                      ),
                    ),
          ...
          actions: [
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all<Color>(const Color.fromARGB(255,100,7,0)),
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  side: const BorderSide(color: const Color.fromARGB(255,100,7,0)),
                ),
                child:
                const Text('CREATE', style: TextStyle(color: const Color.fromARGB(255,100,7,0))),
              ),
            ),
          ],
        ),
...
StateInfo _getStateInfo(String state) {
  switch (state) {
    ...
    case 'cancelled':
      return StateInfo(const Color.fromARGB(255,100,7,0), 'Cancelled');
    case 'rejected':
