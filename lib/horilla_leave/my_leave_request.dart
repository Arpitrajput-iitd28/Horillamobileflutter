                              ...
                              suffixIcon: _fileNameController.text.isNotEmpty
                                ...
                                padding: EdgeInsets.only(
                                    bottom: MediaQuery.of(context)
                                        ...
                                        0.0168),
                                icon:
                                const Icon(Icons.close, color: const Color.fromARGB(255,100,7,0)),
                                onPressed: () {
                                  setState(() {
                                ...
                                suffixIcon: _fileNameController.text.isNotEmpty
                                  ...
                                  padding: EdgeInsets.only(
                                      ...
                                      MediaQuery.of(context).size.height *
                                          0.0168),
                                  icon: const Icon(Icons.close, color: const Color.fromARGB(255,100,7,0)),
                                  onPressed: () {
                                    setState(() {
                                      _fileNameController.clear();
                                    });
              ...
              children: [
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('CREATE', style: TextStyle(color: const Color.fromARGB(255,100,7,0))),
                  ),
                ),
                // ),
              ],
